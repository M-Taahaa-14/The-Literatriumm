...
#     # Relationships with explicit foreign key
#     borrow_records = db.relationship('BorrowRecord', backref='user', lazy=True, foreign_keys='BorrowRecord.user_id')
...
class Book(db.Model):
    ...
    borrow_records = db.relationship('BorrowRecord', backref='book', lazy=True, foreign_keys='BorrowRecord.book_id')
